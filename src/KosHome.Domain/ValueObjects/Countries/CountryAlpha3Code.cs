...
public sealed record CountryAlpha3Code(string Value)
{
    /// <summary>
    ...
    public static CountryAlpha3Code Create(string value)
    {
        ...
        return new CountryAlpha3Code(value.ToUpperInvariant());
    }
}