...
public interface IKeycloakIdentityService
{
    ...
    Task<IEnumerable<IdentityRole>> GetRolesAsync(string realm, int? first = null, int? max = null, string? search = null, bool? briefRepresentation = null, CancellationToken cancellationToken = default);
