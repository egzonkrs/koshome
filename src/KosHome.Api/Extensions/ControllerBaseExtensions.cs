...
public static class ControllerBaseExtensions
{
    ...
    public static ActionResult<TOut> ToActionResult<TIn, TOut>(this ControllerBase controller, Result<TIn> result, HttpStatusCode successCode = HttpStatusCode.OK)
    {
        if (result.IsSuccess)
        {
    ...
    public static ActionResult ToActionResult(this ControllerBase controller, Result result)
    {
        ...
        {
            return controller.StatusCode((int)HttpStatusCode.InternalServerError,
                CreateProblemDetailsInternal(controller.HttpContext, HttpStatusCode.InternalServerError, result));
        }

        return controller.BadRequest(CreateProblemDetailsInternal(controller.HttpContext, HttpStatusCode.BadRequest, result));
    }
