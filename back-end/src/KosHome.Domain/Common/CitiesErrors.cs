...
public static class CitiesErrors
{
    ...
    public static CustomFluentError AlreadyExists(string cityName)
    ...
    public static CustomFluentError InvalidCityName(string cityName)
    ...
    public static CustomFluentError CountryNotFound(string countryId)
